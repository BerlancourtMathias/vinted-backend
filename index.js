...
// mongoose.connect(process.env.MONGODB_URI); //Je me connecte à ma bdd Mongo V *****edit pour exo du front vinted en react, je commente mnogoose car on va utiliser une api****
